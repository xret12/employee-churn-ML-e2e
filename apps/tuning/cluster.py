...
class KMeansCluster:
    ...
    def create_elbow_plot(self, data):
        ...
        try:
            ...
            self.logger.info('Optimum number of clusters: %s' % str(self.kn.knee))
            self.logger.info('End of elbow plotting...')
            return self.kn.knee
        
        except Exception as e:
            self.logger.exception('Exception raised while elbow plotting: %s' % e)
            raise e
    ...
    def create_clusters(self, data, number_of_clusters):
        ...
        try:
            ...
            self.logger.info('Successfully created %s cluster' % str(self.kn.knee))
            self.logger.info('End of creating clusters...')
            return self.data
        
        except Exception as e:
            self.logger.exception('Exception raised while creating clusters: %s' % e)
            raise e
