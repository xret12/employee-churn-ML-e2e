...
class PredictModel:
    ...
    def __init__(self, run_id, data_path):
        ...
        self.loadValidate = LoadValidate(self.run_id, 'PredictModel', 'prediction')
        self.preProcess = Preprocessor(self.run_id, 'PredictModel', 'prediction')
        self.fileOperation = FileOperation(self.run_id, 'PredictModel', 'prediction')
    ...
    def batch_predict_from_model(self):
        try:
            ...
            # preprocess data
            self.preProcess.preprocess_predictset()
            ...
            self.logger.exception('Expception raised while predicting: %s' % e)
            raise e
